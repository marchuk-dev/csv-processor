package com.marchuk.csv.processor.annotations;
...
@ApiResponses(value = {
        ...
        @ApiResponse(responseCode = "501", description = "Not Implemented", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE)),
        ...
        @ApiResponse(responseCode = "504", description = "Gateway Timeout", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE))
})
